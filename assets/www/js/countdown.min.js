...
function TijdVolgendeUur() {
	...
	if (tijdVerschil > 0) {
		var z = document.getElementById("tijdVerschil");
		z.innerHTML = "Nog <b>" + MultiReplace(document.getElementById("TTVLuur2").getElementById("TTVLdag3").innerHTML, "<br>", " ") + " minuten</b> tot " + lesUren[i].uurNaam + "<br/><br/>"
	}
};
