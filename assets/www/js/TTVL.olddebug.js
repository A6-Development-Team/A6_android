...
function TijdVolgendeUur() {
	...
	if (tijdVerschil > 0) {
		...
		document.getElementById("TTVLt").innerHTML = "Over <b>" + tijdVerschil + " minuten</b> ";
		...
		element = document.getElementById("comingupcard");
